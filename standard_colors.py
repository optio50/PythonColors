...
class colors:
    ...
    class bg:
        ...
        pink = '\033[48;5;201m'
        light_pink = '\033[48;5;206m'


# Demo
def stand_colors():
    print(colors.blink, colors.fg.red, colors.reverse, f"{'Blinking & Red'.center(30)}", colors.reset, sep="")
    print(colors.fg.light_red, colors.reverse, f"{'Light Red'.center(30)}", colors.reset, sep="")
    ...
    print(colors.fg.light_gray, colors.reverse, f"{'Light Gray'.center(30)}", colors.reset, sep="")
    ...
    print(colors.fg.light_blue, colors.reverse, f"{'Light Blue'.center(30)}", colors.reset, sep="")
    print(colors.fg.green, colors.reverse, f"{'Green'.center(30)}", colors.reset, sep="")
