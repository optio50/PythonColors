...
"""Colors class: reset all colors with colors.reset two sub classes fg for foreground bg for background use as 
colors.subclass.colorname. i.e. colors.fg.red or colors.bg.green also, colors.reverse, the generic bold, 
colors.reverse, disable, colors.reverse, underline, colors.reverse, reverse, colors.reverse, strike through, 
